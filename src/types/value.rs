...
impl Value {
    pub(crate) fn default(sql_type: SqlType) -> Value {
        match sql_type {
            ...
            SqlType::UInt256 => Value::UInt256(u256::default()),
            ...
            SqlType::Int256 => Value::Int256(i256::default()),
            ...
            SqlType::LowCardinality(nested) => Value::default(nested.clone()),
...
mod test {
    ...
    fn test_display() {
        ...
        assert_eq!("42".to_string(), format!("{}", Value::UInt256(uint!("42"))));
        ...
        assert_eq!("42".to_string(), format!("{}", Value::Int256(int!("42"))));
